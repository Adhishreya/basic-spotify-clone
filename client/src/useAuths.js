...
const useAuth =(code)=>{
    ...
    console.log(code);
    useEffect(()=>{
        fetch('http://localhost:5000/login',{method:'post',body:{code}}).then(res=>{console.log(res.data);
...
useEffect(()=>{
    fetch('http://localhost:5000/refresh',{method:'post',headers:{refreshToken}}).then(res=>{
